...
subtitle: "Menggunakan JASP: Bagian 3 - Model Jalur (*Path Model*) dan Model Regresi"
...
* Ada **urutan waktu** (*temporal order*) {{< fa arrow-circle-right >}} maka desain penelitian *panel*/*longitudinal*/*time series* harus digunakan
...
<img src="libs/path-diagram.png" style="width:40%;"/>
:::
...
* **trust** (variabel independen) = Kepercayaan ibu bahwa perkembangan anak dapat berlangsung secara natural ([**trust in organismic development**](https://link.springer.com/article/10.1007/s11031-008-9092-2)). Diukur dengan skala *likert* yang terdiri dari 5 aitem dengan 7 pilihan respon {{< fa arrow-circle-right >}} dari **sangat tidak setuju** sampai **sangat setuju**.
...
::: {style="text-align: center;"}
<img src="libs/contoh-path.png" style="width:100%;"/>
:::
...
::: {style="text-align: center;"}
<img src="libs/contoh-model.png" style="width:100%;"/>
:::
...
## Dasar *syntax* `lavaan`^[Baujean, A.A. (2014). Latent Variable Modeling Using R: A step-by-step guide. New York: Routledge.]

::: {style="text-align: center;"}
<img src="libs/lavaan.png" style="width:55%;"/>
:::

## Contoh CFA (1)

::: {style="text-align: center;"}
<img src="libs/path-1.png" style="width:80%;"/>
:::
...
::: {style="text-align: center;"}
<img src="libs/path-2.png" style="width:80%;"/>
:::
...
::: {style="text-align: center;"}
<img src="libs/path-3.png" style="width:80%;"/>
:::
...
::: {style="text-align: center;"}
<img src="libs/contoh-path.png" style="width:80%;"/>
:::
