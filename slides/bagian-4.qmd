...
::: {.incremental}
1. **Menggunakan *cut-off* dari literatur tanpa validasi lokal** — *cut-off* yang optimal di satu populasi (misal: Barat, klinik spesialis) mungkin tidak optimal di populasi yang berbeda (misal: Indonesia, layanan primer). Selalu validasi secara di konteks penelitian Anda.
