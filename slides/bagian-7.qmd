...
* Masalah yang muncul kalau tidak ada reduksi:
  - Tidak bisa divisualisasikan (kita akan kesulitan membuat visualisasi 20 "dimensi" sekaligus)
...
| **SEM** | "Bagaimana faktor-faktor laten saling mempengaruhi?" | Tidak dibahas |

: {tbl-colwidths="[20,50,30]"}

## EFA vs CFA — perbandingannya

| EFA | CFA |
| :--- | :--- |
| Jumlah faktor **belum diketahui** — biarkan data mendikte strukturnya | Jumlah faktor **sudah ditentukan** (melalui hipotesis) sebelum mengambil data |
...
::: {.callout-note}
Rotasi **tidak** mengubah total variani yang dijelaskan — hanya mendistribusikannya agar lebih mudah diinterpretasikan.
:::
...
* **Komunalitas (h²)**: proporsi varians *item* yang dijelaskan oleh *semua* faktor bersama

* **Keunikan (u²)**: 1 − h² = varians yang *tidak* dijelaskan oleh faktor mana pun (varians spesifik + *error*)
...
## Menentukan jumlah faktor — jangan hanya mengandalkan Kaiser!
...
* **Teori** — berapa faktor yang disebutkan di literatur?
:::
...
::: {.callout-note}
#### Catatan
Ambang batas RMSEA < .06 ([Hu & Bentler, 1999](https://www.tandfonline.com/doi/abs/10.1080/10705519909540118)) sering dikutip, tapi berasal dari kondisi simulasi yang spesifik. Untuk model dengan banyak indikator atau sampel besar, **RMSEA < .08 sudah dapat diterima**, jangan terlalu kaku pada angka .06.
:::
