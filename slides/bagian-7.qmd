...
|-------|-------------------------|-------------------|
| **CTT** | "Seberapa reliabel skor total ini?" | [Bagian 5](/docs/slides/bagian-5.html) |
| **EFA** | "Berapa faktor laten yang mendasari *item*-*item* ini?" | **Bagian 7** |
| **CFA** | "Apakah struktur faktor yang saya hipotesiskan sesuai dengan data?" | [Bagian 8](/docs/slides/bagian-8.html) |
| **SEM** | "Bagaimana faktor-faktor laten saling mempengaruhi?" | Tidak dibahas dalam mata kuliah ini. [Klik disini apabila tertarik belajar mandiri.](https://rameliaz.github.io/mg-sem-workshop/) |
