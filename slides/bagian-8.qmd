...
* Biasanya digunakan untuk menentukan indeks pada konstruk yang *orthogonal* {{< fa circle-arrow-right >}} contohnya, [*adverse childhood experience*](https://www.sciencedirect.com/science/article/abs/pii/S0145213421003434)
...
Skala dengan *loading* sedang (misalnya semua λ = 0.60, 5 item) bisa menghasilkan CR ≈ 0.74 namun AVE ≈ 0.36. CR fokus pada *"apakah item-item saling berkaitan/berkorelasi?"*; AVE fokus pada *"apakah item-item benar-benar mewakili konstruknya?"*
:::

## AVE vs. *Composite Reliability* (CR)

![](libs/rel_val.JPG){fig-align="center"}
...
* Meskipun begitu, *script* `lavaan` **sangat sederhana** dan familiar dengan *script* `lavaan` memberikan **banyak keuntungan**.
  - Mendorong kemampuan berpikir komputasi yang dapat berkontribusi pada [kemampuan *problem solving*](https://cacm.acm.org/blogcacm/computational-thinking-the-idea-that-lived/).
...
[Unduh Dataset Contoh CFA](https://rameliaz.github.io/statistik-lanjut/materials/contoh-cfa.omv)
