...
* Selain itu, mencegah multikolinearitas antara prediktor dan suku interaksi 
  - Tanpa _centering_, variabel interaksi (X~1~ × X~2~) sangat berkorelasi dengan X~1~ dan X~1~ secara terpisah karena merupakan hasil kali keduanya 
...
* Dengan begitu kita punya 2 model regresi
  ...
  - Model 2 prediktornya **hi** dan interaksi antara **neu** dengan **trust** (_main effect_ + _interction effect_)
...
> Ketika dibandingkan, Model 1 dan Model 2 berbeda signifikan (_F_(1,397) = 29.5, _p_ = .001). _R_^2^ bertambah sedikit (ΔR^2^ = .128). Model 2 (_F_(2,397) = 74.3, _p_ = .001, _Adj. R_^2^ = .429, AIC = 2472, BIC = 2496) dapat menjelaskan varians tingkat kemandirian anak sedikit lebih baik daripada Model 1 (_F_(1,398) = 171.8, _p_ = .001, _Adj. R_^2^ = .300, AIC = 2547, BIC = 2559).
