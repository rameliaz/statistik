...
|-------|-------------------------|-------------------|
| **CTT** | "Seberapa reliabel skor total ini?" | Bagian 2 |
| **EFA** | "Berapa faktor laten yang mendasari *item*-*item* ini?" | **Bagian 4** |
| **CFA** | "Apakah struktur faktor yang saya hipotesiskan cocok dengan data?" | Bagian 5 |
| **SEM** | "Bagaimana faktor-faktor laten saling mempengaruhi?" | Pengantar di Bagian 1–3 |
...
::: {.callout-warning}
**Sangat tidak disarankan** melakukan EFA kemudian CFA pada **sampel yang sama** — kita akan bahas lebih dalam di Bagian 5.
:::
